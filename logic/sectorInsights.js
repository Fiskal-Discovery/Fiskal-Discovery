...
function getSectorInvoiceFinanceInsight(businessName, industry) {
  ...
  switch (sector) {
    ...
    case 'recruitment':
      return `As you indicated you're in recruitment or staffing, specialist recruitment finance may be worth exploring. This can help fund payroll before clients pay their invoices, and some providers may also offer optional back-office or payroll support.`;

    case 'transport':
      return `As you indicated you're in transport, haulage or logistics, Invoice Finance may be especially relevant. It is very common in this sector because businesses often have to pay drivers, fuel, subcontractors and running costs before customers settle their invoices.`;

    case 'healthcare':
      return `As you indicated you're in healthcare, care or a related sector, cashflow timing can be particularly important. If invoices are raised to local authorities, agencies, insurers or commercial clients, Invoice Finance may help release cash sooner while waiting for those payments.`;

    case 'manufacturing':
      return `As you indicated you're in manufacturing or engineering, cashflow timing can be important when raw material costs and production run ahead of customer payments. Invoice Finance can help smooth that gap.`;

    case 'wholesale':
      return `As you indicated you're in wholesale or distribution, Trade Finance may be especially relevant — it allows you to pay suppliers upfront (securing better terms or pricing) without tying up working capital, while Invoice Finance can release cash from outstanding invoices.`;

    case 'retail':
      return `As you indicated you're in retail, stock finance or a revolving credit facility may be worth exploring — both can help fund inventory without locking up working capital. If card payments are taken regularly, a Merchant Cash Advance may also be an option.`;
...
function getSectorNote(businessName, industry) {
  ...
  const notes = {
    construction:          `you indicated you're in construction or a related trade`,
    recruitment:           `you indicated you're in recruitment or staffing`,
    transport:             `you indicated you're in transport, haulage or logistics`,
    healthcare:            `you indicated you're in healthcare, care or a related sector`,
    manufacturing:         `you indicated you're in manufacturing or engineering`,
    facilities:            `you indicated you're in facilities management, cleaning or maintenance`,
